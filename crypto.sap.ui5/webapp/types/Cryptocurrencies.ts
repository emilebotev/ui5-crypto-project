...
export type TimestampPriceKVP = [number, number];

export interface CoinHistoryByIdData {
  prices: TimestampPriceKVP [];
  market_caps: TimestampPriceKVP [];
  total_volumes: TimestampPriceKVP [];
}
